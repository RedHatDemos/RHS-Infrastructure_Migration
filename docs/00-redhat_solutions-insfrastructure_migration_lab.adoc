...
In case the machine is up an running the following message will show up:
+
----
...
----
+ 
To be sure the VMs in the vCenter environment are running, you may use the following command:
+
----
# ansible app -m ping
----
