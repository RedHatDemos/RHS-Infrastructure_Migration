...
. link:https://github.com/RedHatDemos/RHS-Optimize_IT-Infrastructure_Migration/blob/master/docs/01-redhat_solutions-insfrastructure_migration_v2-update_cloudforms.adoc[Infrastructure Migration 1.0 CloudForms appliance update guide ]
