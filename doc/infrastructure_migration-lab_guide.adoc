...
. Once the system is running, use SSH to access your demo server using the private SSH key of `labuser`.
...
If you want a deeper knowledge on how the whole Infrastructure Migration works, you may want to read the link:infrastructure_migration-deployment_guide.adoc[Deployment guide].
