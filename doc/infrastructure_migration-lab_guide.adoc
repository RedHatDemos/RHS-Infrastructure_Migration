...
If you want a deeper knowledge on how the whole Infrastructure Migration works, you may want to read the link:infrastructure_migration-deployment_aguide.adoc[Deployment guide].
