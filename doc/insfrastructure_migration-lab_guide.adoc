...
|Product |Version
|CloudForms |4.6.4+ 
|Red Hat Virtualization |4.2.5+ beta
...
[NOTE]
To practice, a new *Migration Plan* for the rest of the VMs can be created using the available *Infrastructure Mapping*, completing the migration of the whole app. 

If you want a deeper knowledge on how the whole Infrastructure Migration works, you may want to read the link:insfrastructure_migration_v2-deployment.adoc[Deployment guide]. 
