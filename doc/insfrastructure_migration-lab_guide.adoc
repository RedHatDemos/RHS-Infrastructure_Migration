...
.. Navigate to *Compute -> Migration* and choose *Create Migration Plan*. We will select the same infrastructure mapping previously created, `ticket-monster-mapping-rhv`, and select *Import CSV file with a list of VMs to be migrated*. Click *Next*.
+
