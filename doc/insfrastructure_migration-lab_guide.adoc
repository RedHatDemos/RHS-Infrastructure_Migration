...
.. Download the CSV file from link:https://github.com/RedHatDemos/RHS-Infrastructure_Migration/blob/master/scripts/ticket_monster_migration.csv[here] and save it as `ticket_monster_migration.csv`. Check that the content is the following:
+
