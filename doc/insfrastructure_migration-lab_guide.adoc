...
.. Download the CSV file from link:https://raw.githubusercontent.com/RedHatDemos/RHS-Infrastructure_Migration/ims_1.0/scripts/ticket_monster_migration.csv[here] and save it as `ticket_monster_migration.csv`. Check that the content is the following:
+
