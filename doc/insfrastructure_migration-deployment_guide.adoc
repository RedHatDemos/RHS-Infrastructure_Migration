...
+
[TIP]
There is already a file created for you in the environment. The sample file is also available in the repo link:../scripts/conversion_hosts/conversion_hosts_inventory.yml[here]
